...
// so offering those modes here would be a false promise.) Default gets its own
// wording because agy --print is one-shot and cannot prompt: it never asks, it
// just runs under agy's own sandbox settings.
//
