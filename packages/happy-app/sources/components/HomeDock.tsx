...
export const HomeDock = React.memo(({
    ...
    const selectAgent = React.useCallback((agent: NewSessionAgentType) => {
        ...
        // defaults) instead of overwriting them. Upstream seeded defaults here
        // instead; that clobbers the restored per-agent modes, and the rig
        // machine switch it also did is already handled by the effect below.
        setAgentType(agent);
    }, [setAgentType]);
