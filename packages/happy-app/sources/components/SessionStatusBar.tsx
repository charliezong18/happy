...
type SessionStatusBarProps = {
    ...
    /** Plan rate-limit windows (5h/7d) from session metadata, CLI-reported (charlie-main). */
    usageLimits?: {
...
export function SessionStatusBar(props: SessionStatusBarProps) {
    ...
    const limitColor = (percent: number) => percent >= 95
        ? theme.colors.warningCritical
        : percent >= 90
            ? theme.colors.warning
        ...
        <View style={styles.wrapper}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.rightCluster}>
                    ...
                    {limitFiveHour !== null ? (
                        <Text style={[styles.chipText, { color: limitColor(limitFiveHour) }]}>
                            5h {Math.round(limitFiveHour)}%
                        </Text>
                    ) : null}
                    {limitSevenDay !== null ? (
                        <Text style={[styles.chipText, { color: limitColor(limitSevenDay) }]}>
