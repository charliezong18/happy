...
export const ru: TranslationStructure = {
    ...
    imageUpload: {
        ...
        processingFailedTitle: 'Изображение не добавлено',
        processingFailedMessage: ({ count }: { count: number }) => count === 1
            ? 'Одно изображение не удалось прочитать — оно не было добавлено.'
            : `${count} изображений не удалось прочитать — они не были добавлены.`,
    },
