...
function NewSessionScreen() {
    ...
    }, [allMachines, canPickWorktree, currentEffort?.key, currentModelKey, currentPermission?.key, effectiveAgentDefaults.effortLevel, effectiveAgentDefaults.modelMode, effectiveAgentDefaults.permissionMode, navigateToSession, router, selectedAgent, selectedMachineId, selectedPath, worktreeKey, expImageUpload, clearImages, recentPathsByMachine, setRecentPathsByMachine]);
